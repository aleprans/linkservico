...
<head>
    ...
    <link rel="stylesheet" href="style/cadastroPrest.css">
...
<body>
            ...
            <form action=""> 
                ...
                <div class="dados_pessoais">
                    ...
                    <div class="textarea item">    
                        ...
                        <textarea name="descricao_servico" id="descricao_servico" maxlength="280" placeholder="Minino de 20 e no maximo 400 caracteres"></textarea>
                    </div>
                </div>
                <div class="inf">
    ...
    <script src="script/cadastroPrest.js"></script>
</body>
